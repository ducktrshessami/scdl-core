...
export { type CreatorSubscription, type FetchablePlaylistInfo, type FetchablePlaylistInfoData, MimeType, type MinimalTrackInfo, type PartialTrackInfo, PlaylistInfo, type PlaylistInfoData, PlaylistURLPattern, Preset, Protocol, type PublisherMetadata, Quality, type StreamOptions, type StreamablePlaylistInfo, type StreamableTrackInfo, type StreamableTrackInfoData, type TrackInfo, type TrackInfoData, type TrackMedia, type TrackStream, TrackURLPattern, type Transcoding, type UserBadges, type UserInfo, type Visual, type Visuals, fetchPartialPlaylist, getAgent, getClientID, getInfo, getOauthToken, getPermalinkURL, getPlaylistInfo, getPlaylistPermalinkURL, getRequestQueueLimit, getRequestTimeout, isPlaylistFetched, rawResolve, setAgent, setClientID, setOauthToken, setRequestQueueLimit, setRequestTimeout, stream, streamFromInfo, streamFromInfoSync, streamPlaylist, streamPlaylistFromInfo, streamPlaylistFromInfoSync, streamSync, validatePlaylistURL, validateURL };
