import { DataWrapped, PartialTrackInfo, StreamableTrackInfoData, TrackInfoData, UserInfo } from "../info";
import { TrackStream } from "../stream";
export declare class PlaylistInfo<fetched extends boolean = boolean> {
